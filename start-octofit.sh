...
echo ""
echo "⚠️  IMPORTANT: Access the correct port!"
echo ""
echo "✅ Frontend (React App): http://localhost:3000/"
echo "   👆 THIS IS THE ONE YOU WANT! Open this in your browser."
echo ""
echo "📡 Backend API: http://localhost:8000/api/"
echo "   (This is for API calls only - not for browser viewing)"
echo ""
echo "📝 Logs:"
...
echo ""
echo "🛑 To stop:"
echo "   ./stop-octofit.sh"
echo "   OR: kill $DJANGO_PID $REACT_PID"
echo ""
